 ...
 */
abstract class Easyparcel_Data {
	...
	public function read_meta_data( $force_read = false ) {
		...
		// We filter the raw metadata again when loading from cache, in case we cached in an earlier version where filter conditions were different.
	...
	/**
	 * Helper method to compute meta cache key. Different from WP Meta cache key in that metadata cached using this key also contains meta_id column.
	 *
	 * @return string
	 * @since 4.7.0
	 *
