...
jQuery(document).on("click", "#doaction", function (e) {
    if (document.getElementById('bulk-action-selector-top').value == 'order_fulfillment') {
        ...
        jQuery.ajax({
            url: ajaxurl, data: ajax_data, type: 'POST', success: function (response) {
...
jQuery(function ($) {
    var easyparcel_shipping_fulfillment = {
        ...
        save_form: function () {
            ...
            console.log(easyparcel_orders_params)
            var data = {
            ...
            jQuery.ajax({
                url: woocommerce_admin_meta_boxes.ajax_url, data: data, type: 'POST', success: function (response) {
