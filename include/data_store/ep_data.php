...
abstract class EP_Data {
	...
	public function __toString() {
		return wp_wp_json_encode( $this->get_data() );
	}
	...
	protected function error( $code, $message, $http_status_code = 400, $data = array() ) {
		throw new WC_Data_Exception( esc_html($code), esc_html($message), esc_html($http_status_code), esc_html($data) );
	}
}
