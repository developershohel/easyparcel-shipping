...
require_once 'ep_legacy_shipping_zone.php';

/**
 * EP_Shipping_Zone class.
 */
class EP_Shipping_Zone extends EP_Legacy_Shipping_Zone {
    ...
    public function __construct($zone = null) {
        ...
        require_once 'ep_shipping_zones_data_store.php';
        $this->data_store = new EP_Shipping_Zone_Data_Store();
    ...
    public function get_couriers($enabled_only = false, $context = 'admin') {
        ...
        $raw_methods = EP_Shipping_Zones::get_zone_courier($this->get_id());
        // echo'<pre>';print_R($raw_methods);echo'</pre>';
        $methods = array();
